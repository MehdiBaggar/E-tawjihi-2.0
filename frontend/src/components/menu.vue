  ...
  <BContainer fluid>
    ...
    <template v-if="layoutType === 'vertical' || layoutType === 'semibox'">
      <ul class="navbar-nav h-100" id="navbar-nav">
        ...
        <li class="nav-item">
          <router-link to="/" class="nav-link" data-key="t-Test">
      ...
      <ul class="navbar-nav h-100" id="navbar-nav">
        <li class="menu-title">
          <span data-key="t-Commercial"> Commercial</span>
        </li>
        ...
        <li class="nav-item">
          <router-link to="/Convocation" class="nav-link" data-key="t-Convocation">
      ...
      <ul class="navbar-nav h-100" id="navbar-nav">
        <li class="menu-title">
          <span data-key="t-menu"> Tassjil</span>
        </li>
